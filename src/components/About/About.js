      ...
      <div className="Container">
        ...
        <div className="BigCard">
          ...
          <div className="AboutBio">
            ...
            <br></br>
            Now after many years I have grown and found the courage and the voice to dive into WebDev.
            <br></br>
            I found an internship in a start-up for about seven months. Not only did I realized how deep my fascination for not only code but the entire concept of web development is, but also got to discover and impact many other fields that are necessary for a strong company base.
            <br></br>
